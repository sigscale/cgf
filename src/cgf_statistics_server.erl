...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
-module(cgf_statistics_server).
-copyright('Copyright (c) 2016 - 2025 SigScale Global Inc.').

-behaviour(gen_server).

%% export the cgf_statistics_server API
-export([start_link/0]).
...
start_link() ->
	case gen_server:start_link({local, cgf_statistics},
			?MODULE, [[]], []) of
		{ok, Child} ->
			{ok, Child};
		{error, Reason} ->
...
%%----------------------------------------------------------------------
%%  The cgf_statistics_server gen_server call backs
%%----------------------------------------------------------------------
