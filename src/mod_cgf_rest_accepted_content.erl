%%% mod_cgf_rest_accepted_content.erl
%%% vim: ts=3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% 	managed in modules named `cgf_rest_res_*'.
%%%
...
%%% @end
%%%
-module(mod_cgf_rest_accepted_content).
			...
			case proplists:get_value(response, Data) of
				undefined ->
					...
					case string:lexemes(Path, [$/]) of
						["health"] ->
							check_content_type_header(cgf_rest_res_health, ModData);
						["health", "application"] ->
							check_content_type_header(cgf_rest_res_health, ModData);
...
-dialyzer({no_match, check_content_type_header/2}). % remove for post
%% @hidden
check_content_type_header(Module,
		#mod{method = Method, parsed_header = RequestHeaders,
				data = Data} = ModData) ->
